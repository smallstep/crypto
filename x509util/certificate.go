...
func NewCertificateFromX509(template *x509.Certificate, opts ...TOption[*x509.Certificate]) (*Certificate, error) {
	o, err := new(TOptions[*x509.Certificate]).apply(template, opts)
	if err != nil {
		return nil, err
	}
